...
class StockDetails extends Component {
  shouldComponentUpdate(nextProps, nextState) {
    if (nextProps.currentPrice && nextProps.currentPrice.price) {
      if (this.props.currentPrice.price !== nextProps.currentPrice.price) {
        return true;
      }
    }
    return false;
  ...
  _renderBasics() {
    let { open, high, low, volume } = this.props.currentPrice;
